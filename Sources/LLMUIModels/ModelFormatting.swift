...
public enum ModelFormatting {
    public static func backendTitle(_ backend: BackendKind) -> String {
        switch backend {
    ...
    public static func byteCountTitle(_ bytes: Int64?) -> String {
    ...
    public static func capabilityTitles(for descriptor: ModelDescriptor) -> [String] {
