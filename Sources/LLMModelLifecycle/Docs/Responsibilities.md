...
artifact integrity checks, interrupted-download cleanup/resume policy, remote manifest trust policy, and installed record persistence. It does not execute prompts, own session history,
